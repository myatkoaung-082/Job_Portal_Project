                ...
                <div class="sidebar p-2">
                    ...
                    <div class="sidebar-list d-flex align-items-center justify-content-center">
                        <ul class="list-group ps-0 text-start list-unstyled">
                            <li class="{{ request()->routeIs('employer#interviewList') ? 'sideActive' : ''}} list-group-item p-2 mb-2">
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#exampleModal" data-id ="{{ $d->id }}">
                                                        SEND
                                                    </button>
                                                    ...
                                                    <div class="modal fade" id="exampleModal" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <form id="interviewForm" action="{{ route('employer#interviewUpdate', 0) }}" method="post">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="modal-body">
                                                                        <input type="hidden" name="interviewId" id="interviewId">
                                                                        <div class="input-group flex-nowrap mb-3">
                                                                            <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-clock fs-6 text-primary"></i></span>
                                                                            <input type="text" name="time" class="form-control @error('time') is-invalid @enderror" aria-label="Username" aria-describedby="addon-wrapping">
                                                                        </div>
                                                                        @error('time')
                                                                        ...
                                                                        @enderror
                                                                        <div class="input-group flex-nowrap mb-3">
                                                                            <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-calendar-days fs-6 text-primary"></i></span>
                                                                            <input type="date" name="date" class="form-control @error('date') is-invalid @enderror" aria-label="Username" aria-describedby="addon-wrapping">
                                                                        </div>
                                                                        @error('date')
                                                                            <div class=" invalid-feedback">
                                                                                {{ $message }}
                                                                        ...
                                                                        @enderror
                                                                        <div class="input-group flex-nowrap mb-3">
                                                                            <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-location-dot fs-6 text-primary"></i></span>
                                                                            <input type="text" name="location" class="form-control @error('location') is-invalid @enderror" aria-label="Username" aria-describedby="addon-wrapping">
                                                                        </div>
                                                                        @error('location')
                                                                            <div class=" invalid-feedback">
                                                                                {{ $message }}
    ...
    <script>
        $(document).ready(function(){
            $('#exampleModal').on('show.bs.modal', function(event){
                ...
                // logger(interviewId);
                var modal = $(this);
                modal.find('.modal-body #interviewId').val(interviewId);
                modal.find('form').attr('action', 'interview/update/'+ interviewId);
            });
        })
    </script>
