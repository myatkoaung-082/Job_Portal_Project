...
@section('content')
    <div class=" container-fluid">
        <div class="row min-vh-100 min-vw-100 mb-2">
                ...
                <div class="sidebar p-2">
                    ...
                    <div class="sidebar-list d-flex align-items-center justify-content-center">
                        <ul class="list-group ps-0 text-start list-unstyled">
                            ...
                            <li class="{{ request()->routeIs('employer#createPage') ? 'sideActive' : ''}} list-group-item p-2 mb-2">
                                <a href="{{ route('employer#createPage') }}"
                                    class=" text-decoration-none text-light d-flex align-items-center fs-6">
            ...
            <div class="col-lg-10">
                <form action="{{ route('employer#createJob') }}" method="post">
                    @csrf
                    ...
                    <div class="companyBasicInformationCard mt-3 mx-auto rounded shadow-sm" style="width: 960px;">
                        ...
                        <div class="card-body px-5 py-2">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    <label for="" class="form-label fw-bold">Industry</label>
                                    <div class="input-form">
                                        <i class="fa-solid fa-list"></i>
                                        <select name="industry" class="input @error('industry') is-invalid @enderror">
                                            @if ($industry)
                                                ...
                                                @foreach ($industry as $ind)
                                                    <option value="{{ $ind->id }}">{{ $ind->industry_name }}</option>
                                                @endforeach
                                            @else
                                                <option value="">Select Industry</option>
                                            @endif
                                ...
                                <div class="col-lg-6">
                                    <label for="" class="form-label fw-bold">Work Type</label>
                                    <div class="input-form">
                                        <i class="fa-solid fa-list"></i>
                                        <select name="worktype" class="input @error('worktype') is-invalid @enderror">
                                            @if ($workType)
                                                ...
                                                @foreach ($workType as $wt)
                                                    <option value="{{ $wt->id }}">{{ $wt->work_type_name }}</option>
                                                @endforeach
                                            @else
                                                <option value="">Select Work Type</option>
                                            @endif
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    <label for="" class="form-label fw-bold">Salary Type</label>
                                    <div class="input-form">
                                        <i class="fa-solid fa-list"></i>
                                        <input type="text" name="salarytype" class="input @error('salarytype') is-invalid @enderror" id=""
                                            list="salaryType" placeholder="Choose Salary Type" value="{{old('salarytype')}}">
                                ...
                                <div class="col-lg-6">
                                    <label for="" class="form-label fw-bold">Salary Range</label>
                                    <div class="input-form">
                                        <i class="fa-solid fa-list"></i>
                                        <select name="salaryrange" class="input @error('salaryrange') is-invalid @enderror">
                                            @if ($salaryRange)
                                                ...
                                                @foreach ($salaryRange as $sr)
                                                    <option value="{{ $sr->id }}">{{ $sr->salary_range_name }}
                                                    </option>
                                                @endforeach
                                            @else
                                                <option value="">Select Salary Range</option>
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    <label for="" class="form-label fw-bold">Experience Level</label>
                                    <div class="input-form">
                                        <i class="fa-solid fa-list"></i>
                                        <select name="experience" class="input @error('experience') is-invalid @enderror">
                                            @if ($experienceLevel)
                                                ...
                                                @foreach ($experienceLevel as $el)
                                                    <option value="{{ $el->id }}">{{ $el->experience_level_name }}
                                                    </option>
                                                @endforeach
                                            @else
                                                <option value="">Select Experience Level</option>
                                ...
                                <div class="col-lg-6">
                                    <label for="" class="form-label fw-bold">Job Apply Expired Date</label>
                                    <div class="input-form">
                                        <i class="fa-solid fa-list"></i>
                                        <input type="date" name="expdate" class="input @error('expdate') is-invalid @enderror">
                                        @error('expdate')
                                            <span class="text-secondary invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-form">
                                        <i class="fa-solid fa-list"></i>
                                        <input type="text" name="gender" class="input @error('gender') is-invalid @enderror" id=""
                                            list="gender" placeholder="Choose Gender" value="{{old('gender')}}">
                                        <datalist id='gender'>
                                            <option>Male</option>
                                ...
                                <div class="col-lg-6">
                                    <label for="" class="form-label fw-bold">Vacancy</label>
                                    <div class="input-form">
                                        <i class="fa-solid fa-list"></i>
                                        <input type="number" name="vacancy" class="input @error('vacancy') is-invalid @enderror" placeholder="Enter Vacancy" value="{{old('vacancy')}}">
                                        @error('vacancy')
                                            <span class="text-secondary invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-form">
                                        <i class="fa-solid fa-list"></i>
                                        <input type="text" name="age" class="input @error('age') is-invalid @enderror" placeholder="Enter Age" value="{{old('age')}}">
                                        @error('age')
                                            <span class="text-secondary invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                        ...
                        <div class="card-body px-3 pb-2">
                            <div class="row mt-3">
                                <div class="col-lg-12">
                                    ...
                                    <textarea type="text" name="jobDescription" id="jobDescription" class="form-control   @error('jobDescription') is-invalid @enderror" style="height: 10em;" placeholder="Enter Your Job Description...">{{old('jobDescription')}}</textarea>
                    ...
                    <div class="companyBasicInformationCard mt-3 mx-auto rounded shadow-sm" style="width: 960px;">
                        ...
                        <div class="card-body px-3 pb-2">
                            <div class="row mt-3">
                                <div class="col-lg-12">
                                    <textarea type="text" name="jobRequirement" class="form-control @error('jobRequirement') is-invalid @enderror" style="height: 10em;" placeholder="Enter Your Job Requirements...">{{old('jobRequirement')}}</textarea>
                    ...
                    <div class="companyBasicInformationCard mt-3 mx-auto rounded shadow-sm" style="width: 960px;">
                        ...
                        <div class="card-body px-3 pb-2">
                            <div class="row mt-3">
                                <div class="col-lg-12">
                                    <textarea type="text" name="jobBenefit" class="form-control @error('jobBenefit') is-invalid @enderror" style="height: 10em;" placeholder="Enter Your Job Benefits...">{{old('jobBenefit')}}</textarea>
                                    @error('jobBenefit')
                                        <span class="text-secondary invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                    ...
                    <div class="mx-auto text-end my-3" style="width: 960px;">
                        <button type="submit" class="jobCreateBtn btn btn-primary text-light shadow-sm">
                            <i class="fa-solid fa-pen-to-square me-2"></i>Create
                        </button>
                    </div>
                </form>
            ...
            $('.category').change(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#profession').html('');
                        $('#profession').append('<option value=" ">Choose Profession</option>');
...
{{-- <script>
    ...
    form.onsubmit = function() {
        // Populate hidden form input with editor content
        var description = document.querySelector('input[name=jobDescription]');
