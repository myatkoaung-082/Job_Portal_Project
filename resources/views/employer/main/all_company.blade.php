...
@section('content')
    <div class="container mb-5">
        ...
        <form action="{{ route('employer#headerSearchCompany')}} " method="get">
            @csrf
            <div class="row my-3">
                <div class=" col-lg-4">
                    ...
                    <div class="company-card position-relative overflow-visible border border-1 rounded p-3 shadow-sm">
                        ...
                        <div class="position-absolute more-info d-flex justify-content-center w-100" style="left: 0;">
                            ...
                            <a href="@if ($userIndustry)
                                    {{ route('employer#headerCompanyDetail',[$d->user_id, $userIndustry]) }}
                                @else
                                    {{ route('employer#headerCompanyDetail1',$d->user_id) }}
                                @endif"
