                    ...
                    <div class="col-lg-9 mt-2">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="jobCards">
                                    ...
                                    @if(count($companyJob) != 0)
                                        @foreach ($companyJob as $cj)
                                            <div class="col-12 wow animate__fadeInLeft">
                                                <a href="{{route('employer#headerDetail',[$cj->id, $cj->company_id])}}" class="text-decoration-none text-dark">
                                                    <div class="job-card  d-flex flex-column border border-1 rounded my-3 p-3 shadow-sm">
                                                        ...
                                                        {{-- <p class="job-card-description px-2 text-dark">
                                                            @php
                                                               echo  Str::words($cj->job_description, 40, '...');
                                                           @endphp
                                                            @php
                                ...
                                {{$companyJob->appends(request()->query())->links()}}
