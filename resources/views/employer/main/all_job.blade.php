...
@section('content')
    <div class="container min-vh-100">
        ...
        <form action="{{ route('employer#headerSearchJob')}}" method="get">
            @csrf
            <div class="row my-3">
                <div class=" col-lg-3">
        ...
        <div class="row justify-content-evenly ">
            ...
            <div class="col-lg-3">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form action="{{ route('employer#headerFilterJob')}}" method="get">
                            @csrf
            ...
            <div class="col-lg-9">
                @if (count($data) != 0)
                    @foreach($data as $d)
                        ...
                        <a href="{{ route('employer#headerDetail', [$d->id, $d->company_id]) }}"
                            class="text-decoration-none text-dark ">

                            <div class="job-card job-card-height shadow-sm  d-flex flex-column border border-1 rounded my-3 p-2 wow  animate__fadeInRight" >
    ...
    <script>
        $(document).ready(function() {
            $('#state').change(function() {
                ...
                $.ajax({
                    type: 'get',
                    url: '/employer/ajax/townshipData',
                    dataType: 'json',
                    data: {
                        'status': $current
                    },
