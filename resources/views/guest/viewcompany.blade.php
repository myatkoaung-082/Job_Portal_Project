...
@section('content')
    <div class="container mb-5 min-vh-100">
        ...
        <form action="{{ route('guest#searchCompany')}}" method="get">
            @csrf
            <div class="row my-3">
                <div class=" col-lg-4">
        ...
        <div class="row my-5">
            @if (count($data) != null)
            @foreach ($data as $d)
                <div class="col-lg-4 col-md-6 col-sm-12 my-4 wow animate__fadeIn">
                    <div class="company-card position-relative overflow-visible border border-1 rounded p-3 shadow-sm">
                        ...
                        <div class="position-absolute more-info d-flex justify-content-center w-100" style="left: 0;">
                            <a href="@if ($userIndustry)
                                        {{ route('guest#companydetail',[$d->user_id, $userIndustry]) }}
                                    @else
                                        {{ route('guest#companydetail1',$d->user_id) }}
                                    @endif"
            ...
            <div class="row justify-content-center">
                <div
                    ...
                    <h5 class="py-2">There is no company for your searching!</h5>
                </div>
            </div>
            @endif
