...
<div class="container-fluid">
    <div class="row bg-light">
        <div class="col-12 text-center p-2 mt-3">
            <div class="d-flex justify-content-center align-items-center">
                <span class="pe-3 fw-bold">အသုံးပြုနည်းလမ်းညွှန်ကြည့်ရန်နှိပ်ပါ</span>
                <a href="{{route('guest#guide')}}" class="btn btn-info btn-sm p-2 rounded-3"> <i class="fa-solid fa-book"></i> User Guide</a>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-lg-12 text-center wow animate__fadeInUp">
            ...
            <div class="d-flex justify-content-center align-items-center my-5">
                <div class=" rounded-circle  bg-primary text-light d-flex align-items-center justify-content-center me-4" id="one">
                    <b>RELIABILITY</b>
                </div> 
                <div class=" rounded-circle  bg-primary text-light d-flex align-items-center justify-content-center me-4" id="two">
                    <b>RESPONSIBILITY</b>
                </div> 
                <div class=" rounded-circle  bg-primary text-light d-flex align-items-center justify-content-center" id="three">
                    <b>ACCUARACY</b>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row mb-3">
                <div class="col-lg-12 col-md-12 d-flex justify-content-center align-items-center about wow animate__fadeInUp">
