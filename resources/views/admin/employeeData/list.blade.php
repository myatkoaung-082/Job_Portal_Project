...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="col text-end">
            <p class="title-1"><i class="fa-solid fa-database"></i> No of Seekers - {{ count($data) }}</p>
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="my-3 col-3 offset-6">
            <form action="{{route('admin#employeelist')}}" method="get">
                @csrf
                <div class="d-flex">
                                ...
                                <tr class="tr-shadow">
                                    ...
                                    <td class="">
                                        <div class="table-data-feature d-flex justify-content-center gap-2">
                                            <a href="{{ route('admin#viewemployee', $item->id) }}">
