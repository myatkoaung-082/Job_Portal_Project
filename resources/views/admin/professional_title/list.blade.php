...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-6 text-start d-flex align-items-center">
            <p class="title-1"><i class="fa-solid fa-database"></i> All Professional -  {{ $data->total() }}</p>
        </div>
        <div class="col-6 text-end">
            <a href="{{ route('admin#professioncreate') }}">
    ...
    <div class="row mb-3">
        <div class="col-3 d-flex align-items-center">
            ...
            <a href="{{route('admin#professionlist')}}" class=" text-light bg-primary p-2 rounded rounded-1 text-decoration-none">Back</a>
        </div>
        <div class="my-3 col-3 offset-6">
            <form action="{{route('admin#professionlist')}}" method="get">
                @csrf
                <div class="d-flex">
                    <input type="text" name="searchKey" id="" class="form-control me-2" placeholder="Enter Professional_name ... " value = "{{ request('searchKey') }}">
    ...
    <div class="row my-3">
        <div class="col-8 offset-2">
                                ...
                                <tr class="tr-shadow">
                                    ...
                                    <td class="">
                                        <div class="table-data-feature d-flex justify-content-center gap-2">
                                            <a href="{{route('admin#professioneditpage',$item->id)}}">
            ...
            @else
                <h3 class="text-secondary text-center mt-5"><i class="fa-solid fa-circle-exclamation"></i> There is no professional_title here</h3>
            @endif
