        ...
        <div class="swiper container bg-white shadow-sm border border-1  py-3 rounded">
            <div class="swiper-wrapper">
                @foreach ($companyLogos as $c)
                    <div class="swiper-slide d-flex"><a href="{{ route('seeker#companydetail1', $c->user_id) }}"><img
                ...
                @if (count($latestJobs) != 0)
                    @foreach ($latestJobs as $lj)
                        <div class="col-lg-3 job-card mx-auto">
                            <a href="{{ route('seeker#detailJob', [$lj->id, $lj->company_id]) }}"
