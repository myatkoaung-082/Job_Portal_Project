                ...
                <div class="sidebar p-2">
                    ...
                    <div class="sidebar-list d-flex align-items-center justify-content-center">
                        <ul class="list-group ps-0 text-start list-unstyled">
                            ...
                            <li class="{{ request()->routeIs('seeker#editSkill') ? 'sideActive' : ''}} list-group-item p-2 mb-2">
                        ...
                        <div class="companyBasicInformationCard border border-1 overflow-hidden rounded mt-3 shadow-sm">
                            <div class="card-top d-flex align-item-center justify-content-center">
                                <div
                                    ...
                                    <h5 class="mb-0">Edit Skill & Language</h5>
                                </div>
                            </div>

                            <div class=" my-3">
                                <form action="{{ route('seeker#updateSkill') }}" method="post">
                                    @csrf
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="mb-1">
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('skillName', $skills->skill_name) }}" />
                                                    @error('skillName')
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="mb-1">
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('skillLevel', $skills->skill_level) }}" />
                                                    @error('skillLevel')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
