                ...
                <div class="sidebar p-2">
                    ...
                    <div class="sidebar-list d-flex align-items-center justify-content-center">
                        <ul class="list-group ps-0 text-start list-unstyled">
                            ...
                            <li class="{{ request()->routeIs('add#newEducation') ? 'sideActive' : ''}} list-group-item p-2 mb-2">
                        ...
                        <div class="companyBasicInformationCard shadow-sm border border-1 overflow-hidden rounded mt-3">
                            <div class="card-top d-flex align-item-center justify-content-center">
                                <div
                                    ...
                                    <h5 class="mb-0">Add Educational Qualification</h5>
                                </div>
                            </div>

                            <div class=" my-3">
                                <form action="{{ route('seeker#addNewEducationalQualification') }}" method="post">
                                    @csrf
                                        ...
                                        <div class="col-9 col-lg-5">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <select class="form-select @error('degreeLevel') is-invalid @enderror"
                                                        id="" aria-label="Default select example"
                                                        name="degreeLevel">
                                                        <option value="">Select Area of Studies</option>
                                                        ...
                                                        <option value="Myanmar Traditional Medicine">Myanmar Traditional
                                                            Medicine</option>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <select class="form-select @error('areaOfStudies') is-invalid @enderror"
                                                        id="" aria-label="Default select example"
                                                        name="areaOfStudies">
                                                        ...
                                                        <option value="Master Level Course">Master Level Course</option>
                                                        <option value="Master Degree">Master Degree</option>
                                                        <option value="Doctorate Level Course">Doctorate Level Course
                                                        </option>
