                ...
                <div class="sidebar p-2">
                    ...
                    <div class="sidebar-list d-flex align-items-center justify-content-center">
                        <ul class="list-group ps-0 text-start list-unstyled">
                            ...
                            <li class="{{ request()->routeIs('add#newEmploymentHistory') ? 'sideActive' : ''}} list-group-item p-2 mb-2">
                        ...
                        <div class="companyBasicInformationCard shadow-sm border border-1 overflow-hidden rounded mt-3">
                            <div class="card-top d-flex align-item-center justify-content-center">
                                <div
                                    ...
                                    <h5 class="mb-0">Add Employment History</h5>
                                </div>
                            </div>

                            <div class=" my-3">
                                <form action="{{ route('seeker#addNewEmploymentHistory') }}" method="post">
                                    @csrf
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="mb-1">
                                                    <input type="date"
                                                        ...
                                                        placeholder=" " name="endDate" value="{{ old('endDate') }}" />
                                                    @error('endDate')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
